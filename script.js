...
const superheroes = [
    ...
    const superNames = superheroes.map((superheroes) => {
    ...
    const bigHeroes = superheroes.map((superheroes) => {
        return superheroes.name
    }).filter((superheroes) => {
        return superheroes.weight = 200;
    })

    console.log(bigHeroes)

    const firstComic = superheroes.map((superheroes) => {
    ...
    const marvelComics = superheroes.filter((superheroes) => {
        return superheroes.publisher = "Marvel Comics"
    })
    console.log(marvelComics);


    // punten 7 en 8 lukten mij niet!!
